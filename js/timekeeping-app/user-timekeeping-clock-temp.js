...
shift2shift_globalv1.start_time = 0;
    ...
    $.post("backend/timekeeping-app/check-if-still-clocked-in.php", function (result) {
        ...
        if (result.time_for_clock != 'no start') {
            ...
            if (result.break_start != 'no break') {
                ...
                shift2shift_globalv1.start_time = result.time_for_clock * 1000;
                break_start_timestamp = result.break_start;
                ...
                shift2shift_globalv1.start_time = result.time_for_clock * 1000;
                time = moment(result.time_for_clock, "X").format("hh:mm:ss A");
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data != "Error. Clocked in timestamps is not equal to one." && data != "Error. A break has still not been submitted before.") {
                    break_start_timestamp = parseInt(data);
                    ...
                    time = moment(break_start_timestamp * 1000).format('hh:mm:ss A');
                    add_notification_to_page("You started a break at " + time, "clock-break-icon.png");
        ...
        if (shift2shift_globalv1.on_break == false) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data != "Error. A timestamp has still not been submitted before.") {
                        ...
                        shift2shift_globalv1.start_time = timestamp * 1000;
                        shift2shift_globalv1.clocked_in = true;
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    let break_end_timestamp = parseInt(data);
                    let time_to_add = break_end_timestamp - break_start_timestamp
                    shift2shift_globalv1.start_time += (time_to_add * 1000)
                    ...
                    time = moment(break_end_timestamp * 1000).format('hh:mm:ss A');
