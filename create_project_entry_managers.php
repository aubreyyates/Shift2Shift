<?php
    ...
    // Get the entry id
    $tid = $row['time_id'];
    // Get the first name of the employee associated with the entry
    $datastring_first = $row['emp_first'];
    // Get the last name of the employee associated with the entry
    $datastring_last = $row['emp_last']; 
...
<div style='width:100%;height:54px;background-color:rgb(247, 247, 247)'>
    <div id='projectBox' style='width: 97%; height:50px;
        ...
        <?php
            // Check to see if the manager has permission to edit entries
