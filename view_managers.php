...
<section class="main-container">
    ...
    <div class='shadow'>
        ...
        <?php 
            $search_place='Search Managers';
            $link_new = 'manager_account.php';
            $button_name = 'Add Manager';
...
<script>
    ...
    function prepare_entry_line(first, last, id, email) {
        ...
        var text_2 = "</div><form style='position:relative;' method='GET' action='select_manager.php'><input type='hidden' name='manager_id' value='" + id + "'><button class='entry-button-style-2 wide200' type='submit' >Select Manager</button></form></div></div>"
