...
<!-- Main part of page -->
<section class="main-container" style='height:1500px;'>
    ...
    <div class='main-wrapper'>
        ...
        <div class='form_area'>
            ...
            <form id='account_form' name='account_form' class="signup-form" action="includes/signupNewAdmin.inc.php" method="POST">
        ...
        <div class='form_area area warning_info'>
            <h3>Warning</h3>
            <div class='divider black'></div>
            <p> 
                Admins can add, delete, and alter other accounts from their company. They have the highest level of control. Make sure you know who is going to use this account!
            </p>
        </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $( "#submit_form" ).click(function() {
            ...
            if (valid_form == true) {
                if (confirm('Admins can add, delete, and alter other accounts from their company. They have the highest level of control. Are you sure you want to create another one?') == true) {
                    $( "#account_form" ).submit();
                }
            }
        });
    ...
    if (isset($_SESSION['admin_account_created'])) {
        ...
        if ($result == 'true') {
            ...
            <div style='margin-left:50%; margin-left: 64px;'> 
                <p style='padding:0;color:black; font-size:16px; line-height:48px;'>ADMIN ACCOUNT CREATED SUCCESSFULLY</p>
            </div>
        </div>
