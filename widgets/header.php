                ...
                <div id='desktop' style='width:90%; margin:0 auto;'>
                    ...
                    <div class="nav-login">
                        ...
                        <?php
                            ...
                            if (isset($_SESSION['id'])) {
                                ...
                                echo '<form action = "backend/logout-user.php" method="POST">
                                ...
                                <div style="float:right;">
                                    <form id="account_admin" action = "backend/login-user.php" method="POST">
                    ...
                    <?php 
                        ...
                        if (isset($_SESSION['id'])) {
                            ...
                            include "widgets/world-clock.php";
                        }
                    ?>
...
<?php 
    ...
    if (isset($_SESSION['id'])) {
        include "widgets/hamburger-section-signed-in.php";
    } else {
        include "widgets/hamburger-section-signed-out.php";
    }
?>
