    ...
    <div id="grid-1">
      ...
      <div class="image1-words">
        <p id="home-page-words">
          Shift2Shift is an online app created for keeping track of clocked time at work. 
        </p>
      </div>
    </div>
...
<div class="section-3">
  ...
  <div id="demo-area">
    ...
    <form id="account_admin" action="backend/login-system/login-user.php" method="POST">
      ...
      <input value="demo@demo.com" type="text" name="email" placeholder="Username/email" hidden />
      <input value="testtesttest" type="password" name="pwd" placeholder="Password" hidden />
    </form>
  </div>
</div>
...
<div id='full-screen-demo-modal-container'>
  ...
  <div id='demo-modal' style='text-align:center'>
    ...
    <div style='width:80%;margin: 0 auto;'>
      ...
      <div style=''>
        <form id="account_employee" action="backend/login-system/login-user.php" method="POST">
          <button id="demo-button-2" type="submit">Try Demo Employee!</button>
          <input value="demoemployee@demo.com" type="text" name="email" placeholder="Username/email" hidden />
          <input value="testtesttest" type="password" name="pwd" placeholder="Password" hidden />
        </form>
      </div>
