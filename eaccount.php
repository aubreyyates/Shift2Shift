...
<!-- Main part of page -->
<section class="main-container" style='height:1280px;'>
    ...
    <div class='main-wrapper'>
        ...
        <div class='form_area'>
            ...
            <form id='account_form' name='account_form' class="signup-form" action="includes/eaccount.inc.php" method="POST">
...
<script>
    ...
    $(document).ready(function() {
        ...
        $( "#submit_form" ).click(function() {
            ...
            if (valid_form == true) {
                if (confirm('This will cost $1.50/month to have this account. Are you sure you want to create it? Deleting this account will remove the cost.') == true) {
                    $( "#account_form" ).submit();
                }
            }
        });
            ...
            echo "
                ...
                <div class='disappear_modal' style='top:60px; left:50%; margin-left:-250px;width:500px; position:absolute; height:50px;background-color:#fff;z-index:6; border:1px solid rgb(177, 177, 177);box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);' >
                    <div style='margin-left:50%; margin-left: 64px;'> 
                        <p style='padding:0;color:black; font-size:16px; line-height:48px;'>EMPLOYEE ACCOUNT CREATED SUCCESSFULLY</p>
                    </div>
                </div>
