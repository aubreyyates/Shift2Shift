<?php 
    ...
    if (isset($_POST['time_id'])) {
        ...
        // Check to make sure a date is set. If it's not, they don't have permisions
        if (isset($_POST['date'])) {
        ...
        $result = mysqli_query($conn, $sql);
        // Put the data into the database 
        $sql = "UPDATE timeGeneral SET project_id = '$project_id' WHERE time_id = '$time_id';";
        // Execute the sql
        $result = mysqli_query($conn, $sql);
    } else {
